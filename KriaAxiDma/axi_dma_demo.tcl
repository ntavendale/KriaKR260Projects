...
#
# Generated by Vivado on Sat Jul 18 10:03:03 -0600 2026
...
#
#    "C:/Development/KR260Projects/KriaAxiDma/axi_dma_demo/axi_dma_demo.srcs/constrs_1/new/top.xdc"
#
...
proc cr_bd_axi_dma_bd { parentCell } {
  ...
  # Create instance: AXI_FIFO, and set properties
  set AXI_FIFO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 AXI_FIFO ]
...
\
  ...
  connect_bd_intf_net -intf_net AXI_DMA_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins AXI_FIFO/S_AXIS]
  ...
  connect_bd_intf_net -intf_net AXI_FIFO_M_AXIS [get_bd_intf_pins AXI_FIFO/M_AXIS] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  [get_bd_pins AXI_FIFO/s_axis_aclk]
  ...
  [get_bd_pins AXI_FIFO/s_axis_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.749497",
   "Default View_TopLeft":"8,-201",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace portBus fan_en_b -pg 1 -lvl 7 -x 2360 -y 490 -defaultsOSRD
preplace inst AXI_FIFO -pg 1 -lvl 6 -x 2180 -y 360 -defaultsOSRD
preplace inst InterruptsConcat -pg 1 -lvl 2 -x 520 -y 180 -defaultsOSRD
preplace inst ZYNQ -pg 1 -lvl 3 -x 980 -y 410 -defaultsOSRD
preplace inst axi_dma -pg 1 -lvl 5 -x 1810 -y 120 -defaultsOSRD
preplace inst axi_smc_from_dma -pg 1 -lvl 2 -x 520 -y 360 -defaultsOSRD
preplace inst axi_smc_to_dma -pg 1 -lvl 4 -x 1460 -y 390 -defaultsOSRD
preplace inst fan_out_slice -pg 1 -lvl 6 -x 2180 -y 490 -defaultsOSRD
preplace inst rst_ZYNQ_99M -pg 1 -lvl 1 -x 200 -y 640 -defaultsOSRD
preplace netloc AXI_DMA_mm2s_introut 1 1 5 380 110 NJ 110 NJ 110 1610J 240 1990
preplace netloc AXI_DMA_s2mm_introut 1 1 5 380 250 NJ 250 NJ 250 NJ 250 1980
preplace netloc ZYNQ_emio_ttc0_wave_o 1 3 3 1300J 490 NJ 490 NJ
preplace netloc ZYNQ_pl_clk0 1 0 6 20 450 370 450 670 530 1310 500 1620 380 NJ
preplace netloc ZYNQ_pl_resetn0 1 0 4 30 540 NJ 540 NJ 540 1290
preplace netloc fan_out_slice_Dout 1 6 1 NJ 490
preplace netloc rst_ZYNQ_99M_peripheral_aresetn 1 1 5 380 550 NJ 550 1320 480 1630 360 NJ
preplace netloc xlconcat_0_dout 1 2 1 660 180n
preplace netloc AXI_DMA_M_AXIS_MM2S 1 5 1 2020 100n
preplace netloc AXI_DMA_M_AXI_MM2S 1 1 5 370 260 NJ 260 NJ 260 NJ 260 2010
preplace netloc AXI_DMA_M_AXI_S2MM 1 1 5 380 270 NJ 270 NJ 270 NJ 270 2000
preplace netloc AXI_FIFO_M_AXIS 1 4 3 1640 280 NJ 280 2340
...
levelinfo -pg 1 0 200 520 980 1460 1810 2180 2360
pagesize -pg 1 -db -bbox -sgen 0 0 2500 740
"
}
