...
#
# Generated by Vivado on Thu Aug 13 07:36:08 -0600 2026
...
#
#    "d:/Development/KriaKR260Projects/KriaAxiDma/axi_dma_demo/axi_dma_demo.srcs/sources_1/new/axi_fifo.vhd"
#    "D:/Development/KriaKR260Projects/KriaAxiDma/axi_dma_demo/axi_dma_demo.srcs/constrs_1/imports/constraints/top.xdc"
#    "D:/Development/KriaKR260Projects/KriaAxiDma/axi_dma_demo/axi_dma_demo.srcs/sim_1/imports/vhdl/Axi4StreamIn_Test.vhd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "vhdl/axi_fifo.vhd"]"\
 "[file normalize "constraints/top.xdc"]"\
 "[file normalize "vhdl/Axi4StreamIn_Test.vhd"]"\
  ]
  foreach ifile $files {
...
set file "Axi4StreamIn_Test.vhd"
...
set_property -name "top" -value "Axi4StreamIn_Test" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files [list axi_fifo.vhd]] == "" } {
  import_files -quiet -fileset sources_1 d:/Development/KriaKR260Projects/KriaAxiDma/axi_dma_demo/axi_dma_demo.srcs/sources_1/new/axi_fifo.vhd
}
...
\
  ...
  set block_name axi_fifo
  set block_cell_name axi_fifo_0
  if { [catch {set axi_fifo_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_fifo_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins axi_fifo_0/s_axis]
  connect_bd_intf_net -intf_net axi_fifo_0_m_axis [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins axi_fifo_0/m_axis]
  ...
  connect_bd_net -net rst_ZYNQ_99M_interconnect_aresetn  [get_bd_pins rst_ZYNQ_99M/interconnect_aresetn] \
  [get_bd_pins axi_fifo_0/aresetn]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs ZYNQ/SAXIGP1/HPC1_DDR_LOW]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs ZYNQ/SAXIGP1/HPC1_QSPI]
